...
- **Registered ⇒ must be in every param file** — the #1 footgun (runtime abort at param read:
  ...
  phen-split V0 run aborted on the missing `fates_max_plant_density` (demo branch, 2026-07-10).
...
- **Worked example (demo branch / api-31-0):** `fates_max_plant_density` (the Option-C mass-balance recruit
  cap) — FATES commit `408a31ee` on the fork branch `exp/cohort-n-ceiling`; demo branch, 2026-07-07.
