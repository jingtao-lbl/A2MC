...
- `BTRAN_DAILY_MIN` (from `EnergyFluxType%UpdateAccVars`) is a calibration-relevant drought diagnostic for the Kougarok use case (see `use_cases/ELM-FATES_Kougarok/`).
