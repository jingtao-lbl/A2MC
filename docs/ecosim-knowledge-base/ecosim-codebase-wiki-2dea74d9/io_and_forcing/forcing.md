...
- **Precipitation**: applied only to the afternoon hours 13–24, as `RAIN(I) / 12` per hour; hours 1–12 get zero. Each hour's precip is assigned entirely to rain or snow by that hour's `TCA_col > TSNOW` test (`WthrMod.F90:209-221`).
