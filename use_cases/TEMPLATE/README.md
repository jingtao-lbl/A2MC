...
|---|---|---|
| [`config/`](config/README.md) | what a session **sources** — site + round configs, the round ledger | that model's run-workflow skill · `phase0-design` · `model-evolution` |
...
| [`case_template/`](case_template/README.md) | the files staged into every case | that model's run-workflow skill · `phase0-design` |
