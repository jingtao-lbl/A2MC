...
```bash
A2MC_USE_CASE_DIR=use_cases/ATS_template python tools/review_pending_knowledge.py list
A2MC_USE_CASE_DIR=use_cases/ATS_template python tools/review_pending_knowledge.py promote --key ... --verified-by ...
```
