...
Usage:
    ...
    python tools/promote_diagnostic_script.py \
        --source use_cases/EcoSIM_BioCON/memory/phase_results/<stem>/analyze_carbon_balance.py \
        --dest tools --dry-run

    # OFFLINE: promote a reusable test_hypothesis script into the diagnosis library
    python tools/promote_diagnostic_script.py \
        --source use_cases/EcoSIM_BioCON/memory/phase_results/<stem>/test_seedC_bootstrap.py \
